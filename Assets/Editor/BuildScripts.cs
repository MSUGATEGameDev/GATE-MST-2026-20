...
public static class BuildScripts
{
    ...
    {
        BuildForTarget(BuildTarget.StandaloneWindows64, "Dist/Windows/Game.exe");
    }

    [MenuItem("Build/macOS")]
    public static void BuildMacOS()
    {
        BuildForTarget(BuildTarget.StandaloneOSX, "Dist/MacOS/Game.app");
    }

    [MenuItem("Build/Android (AAB)")]
    public static void BuildAndroidAAB()
    {
        BuildForTarget(BuildTarget.Android, "Dist/Android/Game.aab");
    }
